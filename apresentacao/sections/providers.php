...
$tabela = "sgc_".$user['customer_code']."_providers";
...
$query = "SELECT * FROM sgc_".$user['customer_code']."_providers";
...
<section class="content">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            	<table id="providers" class="table table-bordered table-hover">
...
?>
    <tr>
      ...
      <td onclick="open_target('target=provider&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['name']?></td>
      <td onclick="open_target('target=provider&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['email']?></td>
      <td onclick="open_target('target=provider&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['cellphone']?></td>
      <td onclick="open_target('target=provider&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['address_city']?></td>
      <td onclick="open_target('target=provider&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['address_state']?></td>
...
$("input[type=checkbox][class='check_item']:checked").each(function(){
    ...
    var params = 'target=providers&exec=delete_itens_selected&ids_delete='+items_checked;
	open_target(params);
}else{
new PNotify({title: 'Nenhum item selecionado!',text: 'Selecione o item da lista que deseja excluir.',type: 'error'});	
}
