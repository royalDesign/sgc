...
$tabela = "sgc_".$user['customer_code']."_search_satisfactions";
...
$query = "SELECT * FROM sgc_".$user['customer_code']."_search_satisfactions";
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Pesquisas de satisfação</li>
      </ol>
    </section>
...
<section class="content">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            	<table id="search_satisfactions" class="table table-bordered table-hover">

                <thead>
                <tr>
                  <th style="width: 5%;" id="check_all_r"><input type="checkbox" onclick="select_all_item_list();" class="check_all"></th>
...
?>
    <tr>
      ...
      <td onclick="open_target('target=search_satisfaction&id=<?php echo $row['id'];?>');" style="cursor: pointer;"><?php echo $row['title']?></td>
    ...
    <?php endforeach; ?>
                ...
                <tfoot>
                <tr>
                  <th style="width: 5%;" id="id"><input type="checkbox" class="check_all" value="<?php echo $row['id']?>"></th>
                  <th style="width: 10%;">ID</th>
...
$("input[type=checkbox][class='check_item']:checked").each(function(){
    ...
    var params = 'target=search_satisfactions&exec=delete_itens_selected&ids_delete='+items_checked;
	open_target(params);
}else{
new PNotify({title: 'Nenhum item selecionado!',text: 'Selecione o item da lista que deseja excluir.',type: 'error'});	
}
...
<script>
  $(function () {
    $('#search_satisfactions').DataTable()
    $('#example2').DataTable({
      'paging'      : true,
      'lengthChange': false,
      'searching'   : false,
